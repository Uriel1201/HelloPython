...
"""
# **Divisors Methods**
Euler's Totient function plays a crucial role in various areas 
of mathematics including number theory, cryptography, and algorithms.
For instance the security of RSA encryption relies on the difficulty 
of factoring large numbers, which is facilitated by the use of this function 
...
"""
### dynamicPhi(n):
This method dynamically updates the Euler’s totient function ϕ(i) 
for each i less than n. This approach is based on the Euler's product representation, 
where the product is taken over the distinct prime numbers that divide n.
"""
def dynamicPhi(n):
    if n < 0:
